...
<v-app>
    <v-app-bar app class="accent" flat height="100">
        ...
        <v-btn v-for="link in links.slice(1, 4)" :key="`${link.label}--page-link`" class="my-2 mx-8 white--text d-none d-md-flex" text :to="link.url">
            <v-text class="font-weight-medium">{{ link.label }}</v-text>
        </v-btn>
        <v-spacer class="d-none d-md-flex" />
        <v-btn v-for="link in links.slice(0, 1)" :key="`${link.label}--page-link`" class="my-2 mx-1 white--text d-none d-md-flex" text :to="link.url">
            <v-text class="font-weight-medium">{{ link.label }}</v-text>
        </v-btn>
