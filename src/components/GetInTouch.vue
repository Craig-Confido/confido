...
<v-card class="pa-8 my-2 white--text text-left card-shadow">
    <v-row>
        <v-col cols="12" md="6">
            ...
            <v-col v-if="!status" v-model="valid" ref="form" @submit="sendForm" lazy-validation>
                <v-row>
                    <v-col cols="6">
        ...
        <v-col cols="12" md="6" v-if="!status" v-model="valid" ref="form" @submit="sendForm" lazy-validation>
            <v-row>
                <v-col cols="12">
                    <v-textarea v-model="message" :rules="messageRules" :counter="1000" label="Your message *" required height="220px" class="mx-4 white px-2 py-4" />
                </v-col>
            </v-row>
        </v-col>
        <v-col cols="12">
