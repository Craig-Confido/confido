  ...
  <v-card color="#f1f1ff">
      ...
      <h2 class="primary--text">The Solution</h2>
        <v-row>
          <v-col cols="12" md="2" class="text-center">
            <v-icon class="success--text text-h3">{{ card.solution1Icon }}</v-icon>
          </v-col>
          <v-col cols="12" md="2">
        ...
        <v-row>
          <v-col cols="12" md="2" class="text-center">
            <v-icon class="success--text text-h3">{{ card.solution2Icon }}</v-icon>
          </v-col>
          <v-col cols="12" md="2">
        ...
        <v-row>
          <v-col cols="12" md="2" class="text-center">
            <v-icon class="success--text text-h3">{{ card.solution3Icon }}</v-icon>
          </v-col>
          <v-col cols="12" md="2">
    ...
    <v-card-text v-else class="text-left mt-4 px-8 pt-4">
      <h2 class="primary--text">The Solution</h2>
        ...
        <v-row>
          <v-col cols="12" md="2" class="text-center">
            <v-icon class="success--text text-h3">{{ card.solution4Icon }}</v-icon>
          </v-col>
          <v-col cols="12" md="2">
            <h3 class="primary--text">{{ card.solution4Title }}</h3>
          </v-col>
          <v-col cols="12" md="8">
            <p class="primary--text">{{ card.solution4Text }}</p>
          </v-col>
        </v-row>
      </v-card-text>
    <v-card flat class="px-4 pt-4 mx-4 br-15">
      ...
      <v-card-text v-if="card.cols3 == true" class="text-left">
      ...
      <v-card-text v-else class="text-left">
        <v-row  class="primary--text mx-auto text-center mt-4 pb-8">
          ...
          <v-col cols="6" sm="3">
            <v-icon class="secondary--text ml-4 text-h2"
              >{{ card.result4Icon }}</v-icon
            >
            <h3>{{ card.result4Text }}</h3>
          </v-col>
        </v-row>
      </v-card-text>
  </v-card>
