...
<v-container fluid class="pa-0 ma-0">
  <section class="mx-4 mx-lg-16">
    <v-row class="text-left mt-4">
      <v-img src="../../public/images/talentVisual.png" class="d-flex d-md-none mx-md-16" alt="image of people" />
      ...
      <v-spacer />
      <v-col cols="12" sm="5">
        <v-img src="../../public/images/talentVisual.png" class="d-none d-md-flex mx-md-16" alt="image of people" />
      </v-col>
    </v-row>
  </section>
  <v-row class="mt-10 full-width-green px-auto py-8 white--text" no-gutters style="box-shadow: 0px 0px 70px rgba(46, 49, 174, 0.55);">
  ...
  <v-row class="d-none d-md-flex mx-md-16 mx-md-6 mx-lg-16 my-16">
    <v-col cols="12">
      <Logos :logo="logo" />
    </v-col>
  </v-row>
    ...
    <v-col cols="12" md="6">
      <v-card color="white" class="px-8 py-4 my-2 primary--text text-center card-shadow">
        ...
        <v-card-text class="text-h6 primary--text text-center">
          ...
          <p>
            Service Designer | Product Manager
          </p>
          <h1 class="accent--text mb-3">
            •
          </h1>
    ...
    <v-col cols="12" md="6">
      <v-card color="white" class="px-8 py-4 my-2 primary--text text-center card-shadow">
        ...
        <v-card-text class="text-h6 primary--text text-center">
          ...
          <p>
            QA | Platform Engineer | Data Scientist
          </p>
        </v-card-text>
      </v-card>
    </v-col>
