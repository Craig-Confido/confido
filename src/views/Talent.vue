...
<v-container fluid class="pa-0 ma-0">
  ...
  <v-row class="text-left mt-8 mt-md-0 mx-0 mx-md-6 mx-lg-16">
    ...
    <v-col cols="12" sm="6" class="text-right">
      <v-btn class="btn--outlined font-weight-bold mx-auto px-8 py-4" outlined color="primary" rounded href="mailto:contact@confidotalent.com?subject=Talent: I'd like to know more about available roles">
  ...
  <v-row class="mx-0 mx-md-6 mx-lg-16">
    ...
    <v-col cols="12" md="6">
      <v-card color="blue lighten-2" class="pa-8 my-2 white--text text-left card-shadow">
        ...
        <v-card-actions>
          <v-btn class="font-weight-bold px-4 mx-auto primary--text" elevation="0" color="white" rounded href="mailto:contact@confidotalent.com?subject=Talent: I'd like to know more about available roles">Sounds good, let's talk!</v-btn>
        </v-card-actions>
      </v-card>
    </v-col>
  </v-row>
      ...
      <v-card color="blue lighten-2" class="pa-8 my-2 white--text text-left card-shadow">
        <v-row>
          <v-col cols="12" sm="6">
            ...
            <v-card-actions>
              <v-btn class="font-weight-bold px-4 primary--text" elevation="0" color="white" rounded href="mailto:contact@confidotalent.com?subject=Talent: I work in Product, tell me more about roles!">I work in Product!</v-btn>
            </v-card-actions>
          </v-col>
          <v-col cols="12" sm="6">
            <v-card-title class="headline font-weight-bold">
      ...
      <v-card color="accent" class="pa-8 my-2 white--text text-left card-shadow">
        <v-row>
          <v-col cols="12" sm="6">
            ...
            <v-card-actions>
              <v-btn class="font-weight-bold px-4 primary--text" elevation="0" color="white" rounded href="mailto:contact@confidotalent.com?subject=Talent: I work in Engineering, tell me more about roles!">I work in Engineering!</v-btn>
            </v-card-actions>
          </v-col>
          <v-col cols="12" sm="6">
            <v-card-title class="headline font-weight-bold">
