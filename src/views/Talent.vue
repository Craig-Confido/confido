...
<template>
  <v-container fluid class="pa-0 ma-0">
    <section class="ma-4 ma-lg-16">
      <v-row class="text-left mt-10">
        <v-col cols="12" sm="7" class="mt-0 mt-md-12">
          ...
          />
          <h1
            class="display-2 my-16 font-weight-bold"
            aria-label="Talent"
          >Want to build products that make the world a better place?</h1>
          <v-btn
    ...
    <v-row class="text-left mt-8 mt-md-0 mx-0 mx-md-6 mx-lg-16">
      ...
      <v-col cols="12" sm="6">
        <h2>We take time to understand what you're about, your values, what you stand for and the type of startup where you will succeed.</h2>
      </v-col>
      <v-col cols="12" sm="6" class="text-right">
        <v-btn
          ...
          color="primary"
          rounded
          href="mailto:contact@confidotalent.com?subject=Talent: I'd like to know more about available roles"
        >Talk to us about roles</v-btn>
      </v-col>
    </v-row>
    <v-row class="mx-0 mx-md-6 mx-lg-16">
      <v-col cols="12" md="6">
        <v-card color="accent" class="pa-8 my-2 white--text text-left card-shadow">
          <v-card-title class="headline font-weight-bold">Process.</v-card-title>
          <v-row class="mx-1">
            <v-col cols="6">
              <v-icon class="white--text text-lg-h2">mdi-cellphone-sound</v-icon>
              <h3>Brief workshop</h3>
            </v-col>
            <v-col cols="6">
              <v-icon class="white--text text-lg-h2">mdi-card-account-details-star-outline</v-icon>
      ...
      <v-col cols="12" md="6">
        <v-card color="blue lighten-2" class="pa-8 my-2 white--text text-left card-shadow">
          <v-card-title class="headline font-weight-bold">Who we work with.</v-card-title>
          ...
          <v-card-actions>
            <v-btn
              ...
              rounded
              href="mailto:contact@confidotalent.com?subject=Talent: I'd like to know more about available roles"
            >Sounds good, let's talk!</v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
    </v-row>
    <v-row class="my-16 full-width-blue" no-gutters style="height: 8px;"></v-row>
    ...
    <v-row class="mx-0 mx-md-6 mx-lg-16">
      <v-col cols="12">
        <v-card color="blue lighten-2" class="pa-8 my-2 white--text text-left card-shadow">
          <v-row>
            <v-col cols="12" sm="6">
              <v-card-title class="headline font-weight-bold">What we look for.</v-card-title>
              <v-card-text class="white--text">
                ...
                <p>
                  Growth mindset /
                  <br />Invested in self development
                </p>
              </v-card-text>
              <v-card-actions>
                <v-btn
                  class="font-weight-bold px-4 primary--text"
                  elevation="0"
                  color="white"
                  rounded
                  href="mailto:contact@confidotalent.com?subject=Talent: I work in Product, tell me more about roles!"
                >I work in Product!</v-btn>
              </v-card-actions>
            </v-col>
            <v-col cols="12" sm="6">
              <v-card-title class="headline font-weight-bold">Roles we cover.</v-card-title>
              <v-card-text class="white--text">
              ...
              <v-card-actions class="ml-2">
                <h3>
                  From Junior
                  <v-icon class="white--text">mdi-arrow-right</v-icon>VP
                </h3>
              </v-card-actions>
            </v-col>
          </v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <v-card-actions>
                <v-btn
                  ...
                  color="white"
                  rounded
                  href="mailto:contact@confidotalent.com?subject=Talent: I work in Engineering, tell me more about roles!"
                >I work in Engineering!</v-btn>
              </v-card-actions>
            </v-col>
            <v-col cols="12" sm="6">
              <v-card-title class="headline font-weight-bold">Roles we cover.</v-card-title>
              <v-card-text class="white--text">
                <p>
                  ...
                  <br />All stacks and technologies
                </p>
