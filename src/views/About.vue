...
<v-container fluid class="pa-0 ma-0">
    ...
    <v-row class="text-left mt-10">
      <v-col cols="12" sm="7" class="mt-12">
        <h1 class="display-1 mb-3 mt-3 font-weight-bold" aria-label="Karl's posts">
          Startups and people are <span style="color: #7B7DF6"><strong>unique</strong></span>, no two are the same. That’s why hiring is so hard.
        </h1>
        <h2 class="text-lg-h5 my-8">
          Confido focus on aligning the one thing that connects the two, to create something <span style="color: #FF65BD"><strong>special</strong></span>.
        </h2>
        <h3 class="font-weight-black success--text my-8 text-lg-h3">
          Values.
        </h3>
        <v-row class="mt-16">
          <v-btn class="mr-4 btn--outlined font-weight-black" outlined color="accent" rounded width="150" height="50">
            Startups
          </v-btn>
          <v-btn class="mr-4 btn--outlined font-weight-bold" outlined color="secondary" rounded width="150" height="50">
            Talent
          </v-btn>
        </v-row>
      </v-col>
  ...
  <v-row class="mt-10 text-left full-width-pink px-16 py-16 white--text" no-gutters style="box-shadow: 0px 0px 70px rgba(46, 49, 174, 0.55);">
    <v-col cols="12" sm="6">
      ...
      <h3>
        Build Product and Tech
      </h3>
      <h3>
        Seed to Series B
      </h3>
      <h3>
        Products that improve peoples' lives
      </h3>
    </v-col>
    <v-col cols="6" sm="3">
      <h2>
    ...
    <v-col cols="12" md="6">
      <v-card color="accent" class="pa-8 my-2 white--text text-left" style="box-shadow: 0px 20px 70px rgba(46, 49, 174, 0.05);">
        ...
        <v-card-text class="text-h6 mb-14 white--text">
          We are that person you can always go to for honest, straight answers. We don’t judge. We’ve got your back. We tell you what you need to hear, no what you want to hear. W’e’re always there when you need us.
        </v-card-text>
        <v-card-actions>
          <v-btn class="btn--outlined font-weight-bold mx-auto" outlined color="white" rounded to="/startups">
            Scale your team
          </v-btn>
        </v-card-actions>
      </v-card>
      ...
      <v-card color="secondary" class="pa-8 my-2 white--text text-left" style="box-shadow: 0px 20px 70px rgba(46, 49, 174, 0.05);">
        ...
        <v-card-text class="text-subtitle-1 white--text">
          <v-row>
            <v-col cols="6">
              <p>
                We judge people on their values above their skills
              </p>
              <p>
                We believe in data-driven success
              </p>
              <p>
                We know simplicity is key
              </p>
            </v-col>
            <v-col cols="6">
              <p>
              ...
              <p>
                We always understand the ‘why’
              </p>
              <p>
                We are selective about who you invest your time with
              </p>
            </v-col>
          </v-row>
        </v-card-text>
        <v-card-actions>
          <v-btn class="btn--outlined font-weight-bold mx-auto" outlined color="white" rounded to="/talent">
            Accellerate your career
          </v-btn>
        </v-card-actions>
      </v-card>
    </v-col>
