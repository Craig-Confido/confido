  ...
  <section class="mx-4 mx-lg-16">
    <v-row class="text-left mt-4 mt-md-16">
      ...
      <v-col cols="12" sm="6">
        ...
        <!--<v-img src="../../public/images/hero/Confido-Idea-Two_1.png" class="d-none d-md-flex mx-md-8" alt="image of people" />-->
        <!--<v-img src="../../public/images/hero/Confido-Idea-Two_3.png" class="d-none d-md-flex mx-md-8" alt="image of people" />-->
        <!--<v-img src="../../public/images/hero/Confido-Idea-Two_4.png" class="d-none d-md-flex mx-md-8" alt="image of people" />-->
        <!--<v-img src="../../public/images/hero/Confido-Idea-Two_5.png" class="d-none d-md-flex mx-md-8" alt="image of people" />-->
      </v-col>
    </v-row>
  </section>
