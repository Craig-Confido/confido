...
<v-container fluid class="pa-0 ma-0">
  <v-row class="text-left" no-gutters>
    <v-img src="https://images.unsplash.com/photo-1593642532842-98d0fd5ebc1a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=3450&q=80" max-height="440" :aspect-ratio="1.7" gradient="to top right, rgba(100,115,201,1), rgba(25,32,72, .7)">
      <v-row class="mx-0 mx-md-6 mx-lg-16 mt-0 mt-md-6">
        <v-col cols="12" md="6">
          <h1 class="font-weight-bold mb-3 mt-10 overline white--text">
            Featured
          </h1>
          <h2 class="display font-weight-bold mb-3 white--text" aria-label="Confido's posts">
  ...
  <section class="ma-4 ma-lg-16">
    <v-row class="mt-3 mb-5">
      <v-col v-for="post in posts.slice(1,7)" :key="`${post.id}`" cols="12" md="4">
