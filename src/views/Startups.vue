      ...
      <v-card color="success" class="pa-8 my-2 white--text text-left card-shadow">
        ...
        <v-row class="ma-4">
          <v-col cols="6">
            ...
            <v-img src="../../public/images/vision-box.png" width="150" contain eager class="startups mt-8 mt-md-16" />
          </v-col>
          <v-col cols="6">
      ...
      <v-card color="accent" class="pa-8 my-2 white--text text-left card-shadow">
        ...
        <v-row class="ma-4">
          <v-col cols="6">
            ...
            <v-img src="../../public/images/feedr.png" width="150" contain eager class="startups mt-8 mt-md-16" />
          </v-col>
          <v-col cols="6">
