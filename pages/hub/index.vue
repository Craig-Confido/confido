<template>
  <v-container fluid class="pa-0 ma-0">
    ...
    <section class="ma-4 ma-lg-16">
      ...
      <v-row
        class="mt-3 mb-5 post_list"
        :class="{ case_study_list: filter === 'case_study' }"
        v-if="blogs.blogList"
      >
        <v-col
          v-for="(post, index) in blogs.blogList"
          :key="post.id + index"
          cols="12"
          md="4"
...
let title = "Hub",
  desc =
    "Our knowledge hub is a one-stop shop for all things Tech for Good. Explore our hub to find Founder stories and the latest news on Tech and Product hiring.",
