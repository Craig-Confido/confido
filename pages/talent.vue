  ...
  <v-container fluid class="pa-0 ma-0">
    <section class="mx-4 mx-lg-16">
      <v-row class="text-left mt-4">
        <v-img :src="require('../static/images/talentVisual.png')" class="d-flex d-md-none mx-md-16" alt="image of people" />
        <v-col cols="12" sm="7" class="mt-md-16">
          <h1 class="text-h3 text-md-h2 font-weight-bold" aria-label="Intro text">Want to build products that make the world a better place?</h1>
          <h2 class="text-h5 my-8">Work with people who share your values, care about product and will help you accelerate your career.</h2>
          <v-row class="mt-12 mx-0">
            <v-btn class="mb-2 mr-4 btn--outlined font-weight-bold" outlined color="accent" rounded width="250" height="50" @click="$vuetify.goTo('#why')"> Why work with us? </v-btn>
            <v-btn class="mb-2 mr-4 btn--outlined font-weight-bold" outlined color="success" rounded width="250" height="50" @click="$vuetify.goTo('#process')"> Our process </v-btn>
        ...
        <v-spacer />
        <v-col cols="12" sm="5">
          <v-img :src="require('../static/images/talentVisual.png')" class="d-none d-md-flex mx-md-16" alt="image of people" />
        </v-col>
      </v-row>
    </section>
    <v-row class="mt-10 full-width-green py-8 white--text text-center" no-gutters align-content="center" justify="center" style="box-shadow: 0px 0px 70px rgba(46, 49, 174, 0.55)">
      ...
      <v-col cols="6" sm="3" class="px-auto mx-auto mt-2 mt-md-none">
        <v-icon class="text-h2 white--text mb-2"> mdi-clock-outline </v-icon>
        <h1>2 week</h1>
    ...
    <!-- <v-row class="d-none d-md-flex mx-0 mx-md-6 mx-lg-16 my-16" id="roles">
      <v-row class="mx-lg-1" v-if="roles">
        <v-col cols="12">
          <h1>Open roles.</h1>
        </v-col>
    ...
    <v-row class="text-left pt-8 mt-md-0 mx-0 mx-md-6 mx-lg-16 my-16">
      <v-col cols="12">
        <Logos />
      </v-col>
    </v-row>
        ...
        <v-card class="pa-8 my-0 white--text text-left card-shadow">
          ...
          <v-row class="primary--text mx-auto text-center mt-4">
            ...
            <v-col cols="6" sm="3">
              ...
              <h1 class="text-h5 text-md-h4">2 week total</h1>
              <h3 class="text-md-h6">completed interview process</h3>
            </v-col>
            <v-col cols="6" sm="3">
              <v-icon class="secondary--text ml-4 text-h2"> mdi-charity </v-icon>
              <h1 class="text-h5 text-md-h4">Exclusive</h1>
              <h3 class="text-md-h6">client relationships</h3>
            </v-col>
            <v-col cols="6" sm="3">
              <v-icon class="secondary--text ml-4 text-h2"> mdi-account-voice </v-icon>
              <h1 class="text-h5 text-md-h4">Feedback</h1>
              <h3 class="text-md-h6">guaranteed</h3>
            </v-col>
          </v-row>
        </v-card>
      </v-col>
    ...
    <v-row class="mx-0 my-0 py-0 white--text" no-gutters>
      <v-carousel cycle continuous class="mx-0" hide-delimiter-background hide-delimiters light :show-arrows-on-hover="true">
        <v-carousel-item v-for="(quote, index) in quotes" :key="index" class="px-0 mx-0 px-md-16 mx-md-16">
          <v-sheet color="transparent" height="100%" class="px-0 px-md-16 py-0">
            <v-row class="fill-height px-4 px-0 mx-6 mx-lg-16" align="center" justify="center">
              <p class="text-md-h6 text-md-h5 mt-md-16 my-0 py-0 text--primary">
                <strong class="quote">
                  {{ quote.content }}
                </strong>
              </p>
              <v-row class="text-md-h5 mt-12 mb-8 mx-auto" align="center" justify="center">
                <v-spacer />
                <v-col cols="6" md="4">
    ...
    <v-row id="process" class="mx-0 mx-md-6 mx-lg-16">
      <v-col cols="12">
        <ColorWideCard v-for="(card, index_2) in cards" :key="index_2" :card="card" />
      </v-col>
    </v-row>
    <v-row class="text-left mt-8 mt-md-0 mx-0 mx-md-6 mx-lg-16">
      <v-col cols="12">
    ...
    <v-row class="mx-0 mx-md-6 mx-lg-16">
      <v-col cols="12" md="6">
        <v-card color="white" class="px-8 py-4 my-2 primary--text text-center card-shadow">
          ...
          <v-card-text class="text-h6 primary--text text-center">
            <p>CPO | Product Co-founder</p>
            <h1 class="accent--text mb-3">•</h1>
            <p>VP | Head of Product</p>
            <h1 class="accent--text mb-3">•</h1>
            <p>Head of Design | Head of UX</p>
            <h1 class="accent--text mb-3">•</h1>
            <p>Service Designer | Product Manager</p>
            <h1 class="accent--text mb-3">•</h1>
            <p>UX Designer | Product Designer | UI Designer</p>
          </v-card-text>
        </v-card>
      </v-col>
      <v-col cols="12" md="6">
        <v-card color="white" class="px-8 py-4 my-2 primary--text text-center card-shadow">
          ...
          <v-divider />
          <v-card-text class="text-h6 primary--text text-center">
            <p>CTO | Tech Co-founder</p>
            <h1 class="success--text mb-3">•</h1>
            <p>VP | Head of Engineering</p>
            <h1 class="success--text mb-3">•</h1>
            <p>Engineering Manager | Team Lead | Tech Lead</p>
            <h1 class="success--text mb-3">•</h1>
            <p>Frontend | Backend | Full Stack Engineer</p>
            <h1 class="success--text mb-3">•</h1>
            <p>QA | Platform Engineer | Data Scientist</p>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
    <v-row class="mx-0 mx-md-6 mx-lg-16">
      <v-col cols="12">
        <v-card color="accent" class="pa-8 my-2 white--text text-left card-shadow">
          <v-card-title class="headline font-weight-bold"> Values we look for. </v-card-title>
  ...
  data() {
    return {
      ...
      quotes: [
        ...
        {
          content:
            "After having been laid off during the worst recession in living memory, I wasn't 100% sure what to do next. Confido called me as soon as they found out and discussed a few options with me. Within a week, Confido had found me my first consulting gig and made some useful introductions for future work too. I've known Confido for a couple of years now and I'd strongly recommend their services to anyone looking for their next gig in the startup world, or anyone hiring in the startup space.",
          advocate: "Danny B. – Fractional CTO",
          image: "../images/people/jacob.png",
        },
        {
          content: "Confido have been one of the best recruiters I've worked with and I have nothing but praise for them. Confido spent hours going through both the details of what I was looking for in the job market and the set of skills companies were looking for in ideal candidates. As well as discussing interview feedback and providing me with guidance. I would totally recommend Confido if you're either looking for a new job or a company looking to hire.",
          advocate: "Fernando F. – Senior Developer",
          image: "../images/people/fernando.png",
        },
        {
          content: "Confido made the whole searching process so much easier. From the beginning I could tell they really cared about my interests. They were open and clear and managed my expectations with each stage of the process. I couldn't recommend a recruiter more!",
          advocate: "Bella D. – Full Stack Engineer",
          image: "../images/people/bella.png",
        },
        {
          content: "I wasn’t looking to change roles when I was head hunted by Confido but can honestly say that if it wasn’t for the time and effort they put in explaining every detail about the role and company, I wouldn’t have applied.  The great communication and feedback continued through the multiple stage process and really helped me secure a fantastic new position at a great company.",
          advocate: "James F. – VP of Engineering",
          image: "../images/people/james.png",
        },
        {
          content: "I've recently been working with Confido on a Head of QA position; where he has seamlessly ensured that the process was smooth for both me, my family, and of course the hiring company. In fact; if you want results within days and not weeks; I highly recommend Confido as someone who will get the job done.",
          advocate: "Chris C. – Head of DevOps and QA",
          image: "../images/people/chris.png",
        },
        {
          content: "Confido ensured my journey through the recruitment process was not only smooth, but also pleasant and swift. Confido conducts themselves in a professional manner, both with candidates and employers, yet manages to build a level of rapport that you would expect from longer-term acquaintances. They always acted with my interests in mind and were quick to resolve any issues.",
          advocate: "Jacob K. – Frontend Chapter Lead",
          image: "../images/people/jacob.png",
        },
        {
          content: "I couldn't recommend Confido more. They have honestly been one of the best, if not the best recruiter I have worked with. They gave constant feedback, took lots of time to listen and really thought about what I wanted and needed and where would work well for me. I would definitely want to work with them again.",
        ...
        {
          content: "Confido is the best business I've worked with when looking for new career opportunities. From initial contact through to receiving an offer, the experience was painless and I was treated with care and attention. I couldn't recommend Confido enough, whether you're a startup scaling and looking for top tier talent, or an individual looking for a business you can trust to find you the perfect role.",
          advocate: "Karl K. – Product Designer",
          image: "../images/people/karl.png",
        },
        {
          content: "Confido carefully explained the position on offer making sure it aligned with my ambitions. Their communication and feedback was excellent throughout the hiring process. Most importantly, they took the time understand my situation and provided invaluable advice to help me make my decision.",
          advocate: "Stu C. – Senior Product Manager",
          image: "../images/people/stu.png",
        },
        {
          content: "It was an absolute pleasure to work with Confido. They made the process of finding a new role as pain-free and relaxed as possible. They also take the time to get to know candidates; I felt that they really understood my personality, skills and career goals. I'm really excited about the next step in my career, and wouldn't have this new opportunity without Craig.",
      ...
      titles: [
        {
          title: "Want to build products that make the world a better place?",
        },
        {
          title: "Looking for a startup that shares your values?",
        },
      ],
      tab: null,
      cards: [
        {
          ...
          title: "Process.",
          tab1: "Discovery call",
          tab2: "Matching process",
          tab3: "Interview process",
          tab4: "Onboarding",
          icon1: "mdi-phone-in-talk",
          icon2: "mdi-magnify",
          icon3: "mdi-account-voice",
